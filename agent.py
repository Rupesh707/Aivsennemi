...
from game import AIvsEnni, Direction, Point
...
class Agent:
    ...
    def remember(self, state, action, reward, next_state, done):
        """
        Remember the current state, action, reward, next state, and whether the game is done.

        Parameters:
            state (numpy.ndarray): Current state of the game.
            action (list): List representing the action taken.
            reward (float): Reward obtained from the action.
            next_state (numpy.ndarray): Next state of the game.
    ...
    def train_long_memory(self):
        """
        Train the model using experiences stored in memory.
        """
    ...
    def get_action(self, state):
        ...
        Returns:
            list: List representing the action to take.
        """
